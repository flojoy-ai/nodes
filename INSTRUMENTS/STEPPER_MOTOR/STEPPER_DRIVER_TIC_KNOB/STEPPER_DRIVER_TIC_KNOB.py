...
@flojoy
def STEPPER_DRIVER_TIC_KNOB(default: DataContainer, default_parmas: DefaultParams, knob_value: int=0, current_limit: int=30, speed: int=200000, sleep_time: int=2) -> DataContainer:
    """
...
@flojoy
def STEPPER_DRIVER_TIC_KNOB_MOCK(dc_inputs: list[DataContainer], params: dict) -> DataContainer:
