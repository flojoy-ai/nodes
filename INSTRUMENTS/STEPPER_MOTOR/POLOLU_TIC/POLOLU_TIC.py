...
def POLOLU_TIC(
    ...
    motor compatible with the Pololu Tic T500, T249, T825, T834 or T36v4 stepper drivers. It
    returns time elapsed until target position is reached. 
    
    Inputs  
    ------  
    initial_postion
        sets tapper motor starting postion 
    target_position
        sets end of movement node
