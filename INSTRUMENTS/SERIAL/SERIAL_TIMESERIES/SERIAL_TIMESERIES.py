...
@flojoy
def SERIAL_TIMESERIES(default: DataContainer, default_parmas: DefaultParams, comport: str='/dev/ttyACM0', baudrate: int=9600, num_readings: int=100, record_period: float=1):
    """
