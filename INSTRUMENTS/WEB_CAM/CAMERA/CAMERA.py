...
@flojoy
def CAMERA(default: DataContainer, default_parmas: DefaultParams, camera_ind: int=-1, resolution: Literal['default', '640x360', '640x480', '1280x720', '1920x1080']='default') -> DataContainer:
