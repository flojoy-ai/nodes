...
def SINE(default: OrderedPair, amplitude: float=1, frequency: float=1, offset: float=0, phase: float=0, waveform: Literal['sine', 'square', 'triangle', 'sawtooth']='sine') -> OrderedPair:
    x = default.y
    A = amplitude
    F = frequency
    Y0 = offset
