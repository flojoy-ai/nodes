...
@flojoy
def SECOND_ORDER_SYSTEM(default: DataContainer, default_parmas: DefaultParams, d1: float=250, d2: float=100) -> DataContainer:
    ...
    return DataContainer(x=dc_inputs[0].y, y=np.ones_like(dc_inputs[0].y) * float(y_primes[0]))