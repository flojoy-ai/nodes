...
from flojoy import DataFrame, Matrix, OrderedPair, Plotly, flojoy, DefaultParams
...
def SCATTER(default: OrderedPair | DataFrame | Matrix) -> Plotly:
    ...
    if isinstance(default, OrderedPair):
        ...
        raise ValueError(f'unsupported DataContainer type passed for SCATTER: {type(default)}')
