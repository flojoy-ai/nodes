...
def COMPOSITE(
    ...
    if isinstance(figure1, OrderedPair):
        x = figure1.x
    ...
    elif isinstance(figure1, OrderedTriple):
        x = figure1.x
        y = figure1.y
        z = figure1.z
        match first_figure:
    ...
    elif isinstance(figure1, DataFrame):
    ...
    elif isinstance(figure1, Matrix):
    ...
    if isinstance(figure2, OrderedPair):
        x = figure2.x
    ...
    elif isinstance(figure2, OrderedTriple):
        x = figure2.x
        y = figure2.y
        z = figure2.z
        match second_figure:
    ...
    elif isinstance(figure2, DataFrame):
    ...
    elif isinstance(figure2, Matrix):
