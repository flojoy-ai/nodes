...
@flojoy
def COMPOSITE(primary_trace: DataContainer, secondary_trace: DataContainer, default_parmas: DefaultParams, first_figure: Literal['bar', 'line', 'histogram', 'scatter']='scatter', second_figure: Literal['bar', 'line', 'histogram', 'scatter']='scatter') -> DataContainer:
    ...
    match dc_input_1.type:
        ...
        case _:
            raise ValueError(f'unsupported DataContainer type passed for {node_name}: {dc_input_1.type}')
        ...
        case 'matrix':
            ...
            match second_figure:
                ...
                case 'histogram':
                    ...
                    fig.add_trace(go.Histogram(histogram_trace))
        case _:
            raise ValueError(f'unsupported DataContainer type passed for {node_name}: {dc_input_2.type}')
