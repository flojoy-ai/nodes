...
@flojoy
def PROPHET_PLOT(dc: List[DataContainer], params: Dict[str, Any]) -> DataContainer:
    print("PROPHET PLOT plot_plotly")
    try:
    ...
    fig.layout.height = layout.height
    fig.layout.width = layout.width
    fig.layout.xaxis.pop("rangeselector", "")
    fig.layout.xaxis.pop("rangeslider", "")
    fig.layout.autosize = True
    fig.layout.showlegend = True

    fig.write_image("/tmp/plot.jpeg")
