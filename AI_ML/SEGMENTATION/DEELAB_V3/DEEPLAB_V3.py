...
@flojoy
def DEEPLAB_V3(default: DataContainer, default_parmas: DefaultParams) -> DataContainer:
    ...
    return DataContainer(type='image', r=out_img[:, :, 0], g=out_img[:, :, 1], b=out_img[:, :, 2], a=None)