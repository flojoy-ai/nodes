...
@flojoy
def BART_LARGE_CNN(default: DataContainer, default_parmas: DefaultParams) -> DataContainer:
    ...
    if len(dc_inputs) != 1 or dc_inputs[0].type != 'dataframe':
        raise ValueError(f"Invalid input, expected exactly one DataContainer of type 'dataframe'")
