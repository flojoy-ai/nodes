...
def LEAST_SQUARES(dc_inputs: list[DataContainer], params: dict) -> DataContainer:
    """Computes the least square that minimizes the distance between the 
    ...
    tmp = np.array([[1.0,2.0,3.0], [1.0,2.0,4.0], [2.0, 5.0, 1.0]])
    return DataContainer(type="matrix", m=tmp)
