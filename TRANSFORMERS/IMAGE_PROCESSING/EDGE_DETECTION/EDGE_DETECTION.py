...
@flojoy
def EDGE_DETECTION(default: DataContainer, default_parmas: DefaultParams) -> DataContainer:
    ...
    if dc_input.type != 'image':
        raise ValueError(f"unsupported DataContainer type passed to EDGE_DETECTION node: '{dc_input.type}'")
    r = dc_input.r
    g = dc_input.g
    b = dc_input.b
    a = dc_input.a
